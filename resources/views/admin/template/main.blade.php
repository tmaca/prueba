...
<head>
    ...
    <link href="plugins/bootstrap/css/creative.css/creative.css" rel="stylesheet">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#portfolio">Quiénes somos</a>
                </li>
                <li class="nav-item">
...
<header class="masthead">
    ...
    <div class="header-content">
        <div class="header-content-inner">
            <h1 id="homeHeading">Descubre cuánto contaminas</h1>
            <hr>
            <p>En esta aplicación podrás calcular cuánto contaminas y de esa manera podrás concienciarte.</p>
            <a class="btn btn-primary btn-xl js-scroll-trigger" href="#about">Regístrate</a>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 mx-auto text-center">
                <h2 class="section-heading text-white">Log up</h2>
                <hr class="light">
                <p class="text-faded">Aquí irá el formulario para registrarse</p>
